...
If the user wants the intent to persist (a multi-session project, a handoff to another collaborator), offer to save it to `docs/ys-powers/intent/[topic].md`. Only save if they confirm.
